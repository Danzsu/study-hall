...
**Status:** Kész — `Glossary.jsx` támogatja az `Abbr`, `Def`, és `Mixed` gyakorlási módokat.
...
**Status:** Kész — `Glossary.jsx` topic-alapú cluster nézetet kapott, klaszterenkénti mintatermekkel és célzott flash gyakorlással.
